...
sandbox_clean: ## Clean sandbox images,cache,static and database
	...
	# Create database
	testshop/manage.py makemigrations
	testshop/manage.py migrate

sandbox_load_user: ## Load user data into sandbox
	testshop/manage.py loaddata testshop/fixtures/auth.json

sandbox_load_data: ## Import fixtures and collect static
	# Import some fixtures. Order is important as JSON fixtures include primary keys
	testshop/manage.py loaddata fixtures/child_products.json
	testshop/manage.py oscar_import_catalogue fixtures/*.csv
	testshop/manage.py oscar_import_catalogue_images fixtures/images.tar.gz
	testshop/manage.py oscar_populate_countries --initial-only
	testshop/manage.py loaddata fixtures/pages.json fixtures/ranges.json fixtures/offers.json
	testshop/manage.py loaddata fixtures/orders.json
	testshop/manage.py clear_index --noinput
	testshop/manage.py update_index catalogue
	testshop/manage.py thumbnail cleanup
	testshop/manage.py collectstatic --noinput
