...
(
    BenefitList,
    BenefitDetail,
    ConditionalOfferList,
    ConditionalOfferDetail,
    ConditionList,
    ConditionDetail,
) = get_api_classes(
    "views.offer",
...
urlpatterns = [
    ...
    path("conditionaloffer/", ConditionalOfferList.as_view(), name="conditionaloffer-list"),
    path("conditionaloffer/<int:pk>/", ConditionalOfferDetail.as_view(), name="conditionaloffer-detail"),
    path("condition/", ConditionList.as_view(), name="condition-list"),
    path("condition/<int:pk>/", ConditionDetail.as_view(), name="condition-detail"),
